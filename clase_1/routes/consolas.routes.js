...
router.get('/', async (req, res) => {
    ...
    // // con callbacks
    // Consola.find(function(err, consolas) {
    //     if (err) {
    //         return res.status(500).json({ mensaje: 'Error al obtener consolas', error: err.message });
    //     }
    //     res.json(consolas);
    // });
...
//   },
//   {
//     "nombre": "Super Nintendo Entertainment System",
//     "fabricante": "Nintendo",
//     "año": 1991,
//     "generacion": 4,
